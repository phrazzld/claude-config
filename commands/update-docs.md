...
You are the documentation architect. Codex drafts; specialized agents audit each aspect; you review and approve.

## Objective

Audit for documentation gaps. Create what's missing. Update what's stale. Prioritize state diagrams for stateful components.
