...
1. Read `~/.claude/skills/visualize/prompts/shape-plan.md`
...
5. Write to `~/.agent/diagrams/shape-{feature}-{date}.html`
6. Open in browser: `open ~/.agent/diagrams/shape-{feature}-{date}.html`
